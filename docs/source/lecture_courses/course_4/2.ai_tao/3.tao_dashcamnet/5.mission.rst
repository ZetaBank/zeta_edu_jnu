...
-   Rename the untitiled python file to ``02_11-2. tao_dashcamnet_camera.py``
...
-   On the new python file, import the libraries necessary. For our detect task, we need to import the Jetson inference library modules and jetson utility library modules
    ...
    -   ``jetson_inference``: This library contains all the pre-built networks that can be used for inference task and a functions that would allow for custom models to be used for inference tasks.
        ...
        -   ``detectNet``: We are importing detectNet module for our dashcam detection task. 
...
-   After all the libraries are imported, initialize the parser variable with ``argparse.ArgumentParser`` module. 
    ...
    .. code-block:: python
        ...
        parser.add_argument("--network", type=str, default="dashcamnet", help="pre-trained model to load")
...
-   Open the ``02_11-3. tao_dashcamnet_camera.ipynb`` notebook.

.. thumbnail:: /_images/course_4/2.ai_tao/dashcamnet_camera.png
...
-   Check if your python notebook can read the python code you have written:
    ...
    .. code-block:: python
        ...
        !cat /home/zeta/notebook/lecture/'2.AI Training Examples'/'02_11-2. tao_dashcamnet_camera.py'


-   Execute the tao_dashcamnet_camera python code. 
    ...
    *Note* that we are setting our major functions,
    ...
    .. code-block:: python
        ...
        !python3 /home/zeta/notebook/lecture/'2.AI Training Examples'/'02_11-2. tao_dashcamnet_camera.py' $CAMERA
