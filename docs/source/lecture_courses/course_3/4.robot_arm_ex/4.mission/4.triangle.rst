...
.. raw:: html
    ...
    <div style="background: #ffe5b4" class="admonition note custom">
        <p style="background: #ffbf00" class="admonition-title">
            Project Name: Draw a Triangle with the Robot Arm
        </p>
...
Open the mission folder and open the mission-triangle.ipynb file.

- mission-triangle.ipynb

.. thumbnail:: /_images/ai_training/mission_triangle.png
...
.. code-block:: python 
    ...
    # Widgets
    num_input = widgets.IntSlider(min=1, max=90, step=1, value=45, layout=button_layout) # Get the length of the base of the equilateral triangle.
...
.. code-block:: python 
    ...
    if e.action == 'Start':
        movement.move_to_triangle_positions(num_input.value, 1000)
...
.. thumbnail:: /_images/ai_training/gif_triangle_resize.gif
